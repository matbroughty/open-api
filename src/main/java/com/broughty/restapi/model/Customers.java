...
@Schema(name = "Customers", description = "The Customers records represents a customer\\debtor on the Sales Ledger. All Customer records on the Sales Ledger will be pulled.  It is possible to subsequently non-notify the Customer - see the Lending API - but the Customer will still be pulled.   ")
...
public class Customers {
  ...
  @Valid
  private List<@Valid Customer> results = new ArrayList<>();

  public Customers pageNumber(Integer pageNumber) {
  ...
  public Customers pageSize(Integer pageSize) {
  ...
  public Customers totalResults(Integer totalResults) {
  ...
  public Customers links(PaginginfoLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Customers results(List<@Valid Customer> results) {
    this.results = results;
    return this;
  }

  public Customers addResultsItem(Customer resultsItem) {
  ...
  public List<@Valid Customer> getResults() {
    return results;
  }

  public void setResults(List<@Valid Customer> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageNumber, customers.pageNumber) &&
        Objects.equals(this.pageSize, customers.pageSize) &&
        Objects.equals(this.totalResults, customers.totalResults) &&
        Objects.equals(this.links, customers.links) &&
        Objects.equals(this.results, customers.results);
  }
