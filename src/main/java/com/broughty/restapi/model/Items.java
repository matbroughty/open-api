...
@Schema(name = "Items", description = "Sales and Purchase items")
...
public class Items {
  ...
  @Valid
  private List<@Valid Item> results = new ArrayList<>();

  public Items pageNumber(Integer pageNumber) {
  ...
  public Items pageSize(Integer pageSize) {
  ...
  public Items totalResults(Integer totalResults) {
  ...
  public Items links(PaginginfoLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Items results(List<@Valid Item> results) {
    this.results = results;
    return this;
  }

  public Items addResultsItem(Item resultsItem) {
  ...
  public List<@Valid Item> getResults() {
    return results;
  }

  public void setResults(List<@Valid Item> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    Items items = (Items) o;
    return Objects.equals(this.pageNumber, items.pageNumber) &&
        Objects.equals(this.pageSize, items.pageSize) &&
        Objects.equals(this.totalResults, items.totalResults) &&
        Objects.equals(this.links, items.links) &&
        Objects.equals(this.results, items.results);
  }
