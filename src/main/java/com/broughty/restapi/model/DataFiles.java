...
public class DataFiles {
  ...
  @Valid
  private List<@Valid DataFile> results = new ArrayList<>();

  public DataFiles pageNumber(Integer pageNumber) {
  ...
  public DataFiles pageSize(Integer pageSize) {
  ...
  public DataFiles totalResults(Integer totalResults) {
  ...
  public DataFiles links(PaginginfoLinks links) {
    this.links = links;
    return this;
  }
  ...
  public DataFiles results(List<@Valid DataFile> results) {
    this.results = results;
    return this;
  }

  public DataFiles addResultsItem(DataFile resultsItem) {
  ...
  public void setResults(List<@Valid DataFile> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageNumber, dataFiles.pageNumber) &&
        Objects.equals(this.pageSize, dataFiles.pageSize) &&
        Objects.equals(this.totalResults, dataFiles.totalResults) &&
        Objects.equals(this.links, dataFiles.links) &&
        Objects.equals(this.results, dataFiles.results);
  }
